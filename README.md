...
Static HTML, CSS and vanilla JS, with no build step and no dependencies. Open `index.html`
...
the spot. The **text filter next to it already works**; it is not a placeholder.
